...
[Insert diagram: PDU flow down and up the OSI stack with header changes at each layer]
...
[Insert diagram: encoding and signaling process from frame to bits on media]
...
[Insert diagram: Manchester encoding waveform showing bit transitions]
...
[Insert diagram: LLC and MAC sublayer interaction showing data flow through sublayers]
...
[Insert diagram: generic layer 2 frame format with header, payload, and trailer fields]
