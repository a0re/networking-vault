...
[Insert diagram: same-subnet vs cross-subnet communication showing when default gateway is needed]
...
[Insert diagram: packet traversal across routers showing MAC address changes at each hop while IPs remain constant]
