...
[Insert diagram: physical vs logical topology comparison]
...
[Insert diagram: point-to-point, hub-and-spoke, and full mesh WAN topologies]
...
[Insert diagram: half duplex communication - one lane shared for send/receive]

## Full Duplex

- 2 lanes in communication to send and receive. Server allows 2 nodes to send and receive at the same time.

[Insert diagram: full duplex communication - separate lanes for send and receive]
