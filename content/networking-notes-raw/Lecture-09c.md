...
[Insert diagram: hidden node problem - two clients out of range of each other but both in range of AP, causing collisions]

- PC1 and PC2 cannot sense each other, so when sending a packet, a collision occurs at the same time.

[Insert diagram: RTS/CTS handshake resolving hidden node problem]
...
[Insert diagram: ad hoc vs infrastructure mode wireless networks]
...
[Insert diagram: BSS vs ESS coverage areas with overlapping cells at 10-15%]
...
[Insert diagram: 802.11 non-overlapping channels 1, 6, and 11 in the 2.4 GHz band]
...
[Insert diagram: 802.11 client association sequence - probe, authentication, association steps]
