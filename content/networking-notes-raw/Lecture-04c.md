...
[Insert diagram: ARP request broadcast and unicast reply within same subnet]
...
[Insert diagram: ARP request to default gateway when destination is outside local subnet]
