...
[Insert diagram: STP vs PVST+ vs RSTP vs RPVST+ comparison showing scope and convergence speed]
...
[Insert diagram: RSTP port roles - root, designated, alternate, backup with discarding/learning/forwarding states]
...
[Insert diagram: extended BID format with 4-bit priority + 12-bit VLAN ID + 48-bit MAC]
