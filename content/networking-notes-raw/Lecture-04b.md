...
[Insert diagram: classful IPv4 addressing showing Class A, B, C, D, E with octet ranges and subnet masks]
...
[Insert diagram: IPv4 packet header format with all fields - version, IHL, DS, total length, identification, flags, fragment offset, TTL, protocol, header checksum, source IP, destination IP]
...
[Insert diagram: IP fragmentation example showing original packet split into fragments with offset values]
...
[Insert diagram: unicast vs broadcast vs multicast packet delivery comparison]
