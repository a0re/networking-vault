...
[Insert diagram: Router-on-a-Stick topology with single router trunked to switch serving multiple VLANs]
...
[Insert diagram: inter-VLAN routing flow showing packet with VLAN tag changing at each hop]
