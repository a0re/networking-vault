...
[Insert diagram: Ethernet's position in Data Link and Physical layers of OSI]
...
[Insert diagram: CSMA/CD flow - listen, send, detect collision, jam signal, backoff, retransmit]
...
[Insert diagram: MAC address 48-bit format showing OUI (3 bytes) + NIC (3 bytes)]
...
[Insert diagram: IEEE 802.3 Ethernet frame format with preamble, SFD, MAC addresses, length, data, FCS]

## Ethernet II (2)

[Insert diagram: Ethernet II frame format with preamble, MAC addresses, type, data, FCS]
...
[Insert diagram: unicast layer 2 frame with source/destination MAC and IP traversal]
