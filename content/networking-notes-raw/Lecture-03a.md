...
[Insert diagram: VLAN segmentation topology with multiple switches and broadcast domains]
...
[Insert diagram: access port vs trunk port traffic flow with VLAN tagging]
...
[Insert diagram: intra-VLAN communication between hosts in the same VLAN across switches]
...
[Insert diagram: standard Ethernet frame vs 802.1Q tagged frame with 4-byte VLAN tag]

[Insert diagram: 802.1Q frame header showing TPID, PCP, DEI, VID fields]
