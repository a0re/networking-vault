...
[Insert diagram: BID structure - 2-byte bridge priority + 6-byte MAC address]
...
[Insert diagram: STP topology with root bridge, root ports, designated ports, and blocked ports]
...
[Insert diagram: STP port state transition flow - blocking → listening → learning → forwarding]
