...
[Insert diagram: packet structure showing headers + data encapsulation format]
...
[Insert diagram: TCP/IP stack vs OSI model layers side-by-side]
...
[Insert diagram: encapsulation path Data→Segment→Packet→Frame→Bits]
...
[Insert diagram: OSI model layers with descriptions and TCP/IP mapping]